...
alter table compra add constraint compra1_fk foreign key (nrocomercio) references comercio (nrocomercio);
alter table rechazo add constraint rechazo_fk foreign key (nrotarjeta) references tarjeta (nrotarjeta);
alter table rechazo add constraint rechazo1_fk foreign key (nrocomercio) references comercio (nrocomercio);
...
alter table alerta add constraint alerta1_fk foreign key (nrorechazo) references rechazo (nrorechazo);
alter table consumo add constraint consumo_fk foreign key (nrotarjeta) references tarjeta (nrotarjeta);
alter table consumo add constraint consumo2_fk foreign key (codseguridad) references tarjeta (codseguridad);
alter table consumo add constraint consumo3_fk foreign key (nrocomercio) references comercio (nrocomercio);
alter table consumo add constraint consumo4_fk foreign key (monto) references compra (monto);
...
alter table detalle add constraint detalle_nombrecomercio_fk foreign key (nombrecomercio) references comercio (nombre);
alter table detalle add constraint detalle_monto_fk foreign key (monto) references compra (monto);
...
alter table consumo add constraint consumo_codseguridad_fk foreign key (codseguridad) references tarjeta (codseguridad);
alter table consumo add constraint consumo_nrocomercio_fk foreign key (nrocomercio) references comercio (nrocomercio);
alter table consumo add constraint consumo_monto_fk foreign key (monto) references compra (monto);*/
